      ...
      <section className="py-16 bg-white rounded-3xl p-8 shadow-lg">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {technologies.map((tech, index) => (
            <div
              key={index}
              className={`${tech.color} text-white px-6 py-3 rounded-full font-semibold`}
            >
              {tech.name}
            </div>
          ))}
      ...
      <section className="py-16 text-center">
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white">
          ...
          <p className="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
            একটি কথাবার্তা দিয়ে শুরু করুন। আপনার আইডিয়া শেয়ার করুন, আমি সেটা
            রিয়েলিটিতে পরিণত করব।
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/services/chate">
