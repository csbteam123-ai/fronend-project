    ...
    <div className="min-h-screen bg-white text-gray-900 py-5">
      ...
      <section className="py-12 md:py-20 bg-gradient-to-r from-gray-50 to-white">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Professional <span className="text-gray-700">Digital Services</span></h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            We provide top-notch digital solutions to help your business grow in the modern online landscape.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We offer a range of professional digital services to meet all your business needs.
            </p>
          </div>
              ...
              >
                ...
                <ul className="mb-6 space-y-2">
                  {service.features.map((feature, index) => (
                    <li key={index} className="flex items-start">
                      <svg className="w-5 h-5 text-gray-800 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-gray-600 ml-1">/{service.priceType}</span>
                  </div>
      ...
      <section id="pricing" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Service Pricing</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Transparent pricing for all our services. Custom packages available for larger projects.
            </p>
          </div>
              ...
              <tbody>
                {servicesData.map((service, index) => (
                  <tr key={service.id} className={`border-b ${index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}`}>
                    ...
                    <td className="p-4">
                      <span className={`px-3 py-1 rounded-full text-sm ${service.priceType === 'project' ? 'bg-gray-200 text-gray-800' : 'bg-gray-800 text-white'}`}>
                        {service.priceType === 'project' ? 'Per Project' : 'Monthly'}
                      </span>
                    </td>
                    <td className="p-4">
                      {service.id === 1 ? '2-4 weeks' : service.id === 2 ? 'Ongoing' : '1-2 weeks'}
                    </td>
                    <td className="p-4">
                      {service.id === 1 ? 'Businesses & Startups' : service.id === 2 ? 'Brand Awareness' : 'Visual Identity'}
                    </td>
                  </tr>
                ))}
              </tbody>
          ...
          <div className="mt-12 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Contact us for tailored packages that fit your specific requirements and budget.
            </p>
      ...
      <footer className="bg-black text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h2 className="text-2xl font-bold">Digital<span className="text-gray-300">Services</span></h2>
              </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} DigitalServices. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
