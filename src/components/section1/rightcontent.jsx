...
const rightcontent = () => {
  return (
    <div className=' w-2/3  py-5 px-5 flex  max-[639px]:flex-col gap-10'>
        <div className='bg-red-400 h-full w-1/3 rounded-3xl overflow-hidden relative div2337'>
            ...
            <div className='h-full w-full top-0 left-0 absolute  py-5 px-5 flex flex-col justify-between '>
                ...
                <div className=' flex flex-col gap-15'>
                    <p className='text-shadow-2xs shadow div-p22337'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum sunt obcaecati dolorem aspernatur, quis corrupti accusantium deleniti eligendi numquam vitae!</p>
